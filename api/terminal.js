...
const fileContents = {
  ...
  基于记忆混乱现象，我们制定了多个计划试图解决，最后发现只有一个计划似乎可行——记忆唤醒计划。为了保证计划的成功，毕竟我们的机会只有一次，我们展开了针对存活人类记忆唤醒的研究。通过心理实验的名义召集了一批受试者，通过催眠的手段将他们参加这次实验的记忆消除，随后重新以心理实验的名义再次召集这些受试者，使用不同的方式唤醒他们上次实验的记忆，通过观察得到唤醒人类记忆的有效方法。
